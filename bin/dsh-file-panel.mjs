 ...
 *   node bin/dsh-file-panel.mjs install --home "/path/to/harness"
 *
...
const ASSETS = ['index.js', 'client.js', 'cordis.patch.yml', 'package.json', 'README.md', 'README.vn.md', 'LICENSE']
