/**
 * Host half of `nyx-file-panel`.
 *
 * Serves the panel's data plane over `/api/nyx-file-panel.*`: file content, the
...
/** Build marker, reported by `GET /api/nyx-file-panel.health`. */
